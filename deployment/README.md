...
- [Data requirements for onboarding new datasets](doc/NewDataRequirements.md): CSV and `CDEsMetadata.json` format rules, including additional constraints for longitudinal data.
- [Keycloak documentation](doc/keycloak/README.md): index for user setup, role/group authorizations, local user creation, and Keycloak state export.
