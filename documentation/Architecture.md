...
- The **platform-ui** acts as the main entry point to the business offerings of the MIP for researchers and clinicians
...
The following diagram, Figure 4 – User Interface, depicts the main functional areas that the UI offers and its interactions within the MIP architecture layers.
![Platform-UI](./images/platform_ui.png)
**Figure 4: Platform-UI**
